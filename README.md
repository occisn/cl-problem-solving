...
Project Euler problems solved are: [1](https://projecteuler.net/problem=1), [3](https://projecteuler.net/problem=3), [5](https://projecteuler.net/problem=5), [6](https://projecteuler.net/problem=6), [9](https://projecteuler.net/problem=9).
